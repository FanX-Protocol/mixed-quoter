...
contract DeployQuoter is Script {
    ...
    function run(address poolManager, address v3Factory, address v2Factory, address weth9)
        public
        returns (MixedRouteQuoterV2 state)
    {
        vm.startBroadcast();
        ...
        state = new MixedRouteQuoterV2(IPoolManager(poolManager), v3Factory, v2Factory, weth9);
